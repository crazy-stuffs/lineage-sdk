...
public class Build {
    ...
    public static final String EVEREST_VERSION = getString("ro.everest.version");

    /** A build ID string meant for displaying to the user */
    public static final String EVEREST_DISPLAY_VERSION = getString("ro.everest.display.version");
